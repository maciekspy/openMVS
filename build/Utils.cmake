...
macro(optimize_default_compiler_settings)
	...
	if(CLANG AND (CMAKE_CXX_STANDARD EQUAL 11 OR CMAKE_CXX_STANDARD EQUAL 14 OR CMAKE_CXX_STANDARD EQUAL 17))
		if(NOT DEFINED CLANG_DEFAULT_CXX_STDLIB)
			set(CLANG_DEFAULT_CXX_STDLIB "libc++")
		endif()
		message("Using stdlib: ${CLANG_DEFAULT_CXX_STDLIB}")
		set(CMAKE_EXE_LINKER_FLAGS "-stdlib=${CLANG_DEFAULT_CXX_STDLIB}")
		add_extra_compiler_option(-stdlib=${CLANG_DEFAULT_CXX_STDLIB})
	endif()
